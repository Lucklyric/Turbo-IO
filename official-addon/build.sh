...
xcrun --sdk iphoneos clang -arch arm64 -isysroot "$sdk_path" -miphoneos-version-min=16.0 \
  ...
  -framework Foundation -framework UIKit -framework Security -framework UniformTypeIdentifiers -framework CoreLocation -framework Speech -framework AVFoundation \
  ...
  Core.m Profile.m KnowledgeClient.m KnowledgeUI.m ProfileUI.m HomeTabLayout.m HomeTabBridge.m ResearchCatalog.m ResearchUI.m LocalListen.m LocalListenUI.m LocalListenAuto.m LocalGlasses.m LocalScript.m LocalCues.m ../page-teleprompter/TIOTokens.m ../page-teleprompter/PageTeleprompter.m ../page-teleprompter/FollowSession.m -I../page-teleprompter LocalASR.m NewsPresentation.m PrivateBootstrap.m WebSearch.m OpenAIResponses.m TodoProtocol.m TodoRuntime.m NewsCore.m NewsReader.m NewsTeleprompter.m RecordingExports.m RecordingExportsUI.m RecordingExportsMenu.m RecordingText.m RecordingTextUI.m RecordingTextMenu.m AlwaysOnAudioFiles.m AlwaysOnOgg.m AlwaysOnAudioNative.m AlwaysOnAudioUI.m Addon.m -o "$output"
